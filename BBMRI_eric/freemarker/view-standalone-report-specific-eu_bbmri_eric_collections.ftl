  ...
  <!-- Biobank details -->
	<#if entity.get('biobank')??>
        ...
        <div class="media-left">
        	<a href="#" >
            	<img alt="logo" width="100px" src="http://www.geonames.org/flags/x/${country.get('id')?lower_case}.gif">
          	</a>
        </div>
        ...
        <tr>
          	...
          	<td>
          		<#list entity.get('type') as type>
          			${type.get('label')}<#if type_has_next>,</#if>
          		</#list>
          	</td>
        </tr>
        ...
        <tr>
          	...
          	<td>
            	<#list entity.get('sex') as sex>
            		${sex.get('label')}<#if sex_has_next>,</#if>
            	</#list>
          	</td>
        </tr>
        </#if>
        ...
        <tr>
          	...
          	<td>
            	<#list entity.get('storage_temperatures') as temperatures>
            		${temperatures.get('label')}<#if temperatures_has_next>,</#if>
            	</#list>
          	</td>
        </tr>
        </#if>
          	...
          	<td>
            	<#list entity.get('materials') as materials>
              		<#if (materials.get('label'))??>
              			${materials.get('label')}<#if materials_has_next>,</#if>
              		</#if>
            	</#list>
          	</td>
        </tr>
        ...
        <tr>
          	...
          	<td>
          		<#list entity.get('data_categories') as categories>
          			${categories.get('label')}<#if categories_has_next>,</#if>
          		</#list>
          	</td>
        </tr>
        <tr>
          	...
          	<td>
          		<#list entity.get('diagnosis_available') as diagnosis>
          			${diagnosis.get('label')} (${diagnosis.get('id')})<#if diagnosis_has_next>,</#if>
          		</#list>
          	</td>
        </tr>
        <tr>
