        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <#if entity.get('sub_collections')?? && entity.get('sub_collections')?has_content>
					- <a href="https://molgenis109.gcc.rug.nl/menu/main/dataexplorer/details/eu_bbmri_eric_collections/${entity.get('id')}">${entity.get('id')}</a>
                	<br/>
                	<#list entity.get('sub_collections') as subs>
                    	<span style="margin-left:2em"><small>+ <a href="https://molgenis109.gcc.rug.nl/menu/main/dataexplorer/details/eu_bbmri_eric_collections/${subs.get('id')}">${subs.get('id')}</a></small></span>
                		<#if subs_has_next><br/></#if>
                    </#list>
                <#elseif entity.get('parent_collection')?? && entity.get('parent_collection')?has_content>
                	- <a href="https://molgenis109.gcc.rug.nl/menu/main/dataexplorer/details/eu_bbmri_eric_collections/${entity.get('parent_collection').get('id')}">${entity.get('parent_collection').get('id')}</a>
                	<br/>
                	<span style="margin-left:2em"><small>+ <a href="https://molgenis109.gcc.rug.nl/menu/main/dataexplorer/details/eu_bbmri_eric_collections/${entity.get('id')}">${entity.get('id')}</a></small></span>
                <#else>
                	<a href="https://molgenis109.gcc.rug.nl/menu/main/dataexplorer/details/eu_bbmri_eric_collections/${entity.get('id')}">${entity.get('id')}</a>     
                </#if> 
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <table class="table table-striped ">
                    ...
                    <tr>
                        <th scope="row">Bioresource reference</th>
                        <td>
                            <#if entity.get('bioresource_reference')??>
                                ${entity.get('bioresource_reference')}
                            </#if>
                        </td>
                    </tr>
                    </tbody>
