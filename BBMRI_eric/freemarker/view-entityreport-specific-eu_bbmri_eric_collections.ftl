            ...
            <div class="col-md-4">
                ...
                <table class="table table-striped ">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="${entity.get('sample_access_uri')}"
                               target="_blank">${entity.get('sample_access_uri')}</a>
                        </td>
                    </tr>
                    </#if>
                    </tbody>
            ...
            <div class="col-md-4">
                ...
                <table class="table table-striped ">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="${entity.get('data_access_uri')}"
                               target="_blank">${entity.get('data_access_uri')}</a>
                        </td>
                    </tr>
                    </#if>
                    </tbody>
            ...
            <div class="col-md-4">
                ...
                <table class="table table-striped ">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="${entity.get('image_access_uri')}"
                               target="_blank">${entity.get('image_access_uri')}</a>
                        </td>
                    </tr>
                    </#if>
                    </tbody>
